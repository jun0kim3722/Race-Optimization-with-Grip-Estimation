    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(234)  = dumData; %prealloc
                    ...
                    section.data(229).dtTransOffset = 506;

                    ;% rtP.Integrator_IC_i
                    section.data(230).logicalSrcIdx = 229;
                    section.data(230).dtTransOffset = 507;

                    ;% rtP.Saturation1_UpperSat_b
                    section.data(231).logicalSrcIdx = 230;
                    section.data(231).dtTransOffset = 508;

                    ;% rtP.Saturation1_LowerSat_h
                    section.data(232).logicalSrcIdx = 231;
                    section.data(232).dtTransOffset = 509;

                    ;% rtP.Saturation_UpperSat_fp
                    section.data(233).logicalSrcIdx = 232;
                    section.data(233).dtTransOffset = 510;

                    ;% rtP.Saturation_LowerSat_h
                    section.data(234).logicalSrcIdx = 233;
                    section.data(234).dtTransOffset = 511;
    ...
    targMap.checksum0 = 2763915399;
    targMap.checksum1 = 212292232;
    targMap.checksum2 = 4176857063;
    targMap.checksum3 = 4011425084;
