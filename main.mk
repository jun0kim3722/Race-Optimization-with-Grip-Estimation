...
MODEL                   = main
MODULES                 = rt_logging.c main.c main_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rsim_main.c rsim_sup.c rsim_mat.c simulink_solver_api.c rsim_utils.c common_utils.c rt_sim.c ode3.c
...
START_DIR               = C:\Users\liam0\OneDrive\Desktop
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 4
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="C:\\Program Files\\MATLAB\\R2024b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DRT -DRSIM_PARAMETER_LOADING -DTID01EQ=1"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = /LIBPATH:"C:\Program Files\MATLAB\R2024b\extern\lib\win64\microsoft" libmat.lib libmx.lib libut.lib libmwsl_fileio.lib libmwsl_simtarget_instrumentation.lib libmwsigstream.lib libmwsl_AsyncioQueue.lib libmwfoundation_i18n_init_c_api.lib sf_runtime.lib
