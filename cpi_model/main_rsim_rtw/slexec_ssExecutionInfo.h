...
typedef struct ssExecutionInfo_tag {
    ...
    struct SimulationOptions {
        ...
        const char* compileInfoFilename_;
        const char* liveConnectionsFilename_;
        const char* timeLimit_;           /* time out for executable */
        const char* outputSaveName_;
        const char* stateSaveName_;
        const char* finalStateName_;
    ...
    struct RuntimeCallbacks {
        ...
        int (*setupFcn)(int_T, char_T**);
        void (*tearDownFcn)(SimStruct*);
    } runtimeCallbacks_;
