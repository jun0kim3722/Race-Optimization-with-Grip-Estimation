...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_getfield(
    ...
    const char* errName,    
    int index);             
LIBMWSF_RUNTIME_API void sf_mex_setfieldbyindex(const mxArray* mxStruct,
                                                int index,
...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_create_sparse(void* d,
                                                        ...
                                                        int32_T aClassId,
                                                        int32_T aComplexity);
LIBMWSF_RUNTIME_API void sf_mex_check_sparse(const emlrtMsgIdentifier* aMsgId,
                                             mxArray* pa,
                                             int32_T* pDims,
                                             boolean_T* aDynamic,
                                             int32_T aClassId,
...
LIBMWSF_RUNTIME_API mxArray* sf_mex_create_enum(const char* enumName, const mxArray* mxValues);
...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_createstructarray(
    ...
    int numFields,
    const char** fldName);
LIBMWSF_RUNTIME_API mxArray* sf_mex_create_from_dynamic_string(
    const char* nameStr,      
    void* dataPtr,            
    int dataType,             
    ...
    int numDims,              
    ...);                     
LIBMWSF_RUNTIME_API mxArray* sf_mex_create(
    const char* nameStr,      
    const void* dataPtr,      
    int dataType,             
    unsigned int isComplex,   
...
LIBMWSF_RUNTIME_API void sf_mex_check_is_fixed_point_type(const emlrtMsgIdentifier* aMsgId,
                                                          const mxArray* aSrcMx);
LIBMWSF_RUNTIME_API void sf_mex_check_is_fixed_point_type_named(const char* aSrcName,
                                                                const mxArray* aSrcMx);
