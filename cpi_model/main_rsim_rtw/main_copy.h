...
#define NBLOCKIO                       (60)                      /* Number of data output port signals */
...
typedef struct {
  ...
  real_T FlipTire1;                    /* '<S1>/Flip Tire1' */
  real_T Gain;                         /* '<S3>/Gain' */
  real_T Sum2;                         /* '<S3>/Sum2' */
 ...
 *
 * Block '<S2>/Flip Tire1' : Unused code path elimination
 * Block '<S2>/Flip Tire2' : Unused code path elimination
 * Block '<S2>/Flip Tire3' : Unused code path elimination
