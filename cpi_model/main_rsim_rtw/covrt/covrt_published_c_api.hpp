...
EXTERN_C LIBCOVRT_API void covrtSimulinkInstanceEnter(CovrtSimulinkInstance* instance, int sysIdx, int blockInstanceIdx, double time);
...
EXTERN_C LIBCOVRT_API void covrtSerializeCoverageStreamData(CovrtSimulinkInstance* instance);
