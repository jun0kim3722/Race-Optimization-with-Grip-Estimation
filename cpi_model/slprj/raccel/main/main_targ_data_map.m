    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(228)  = dumData; %prealloc
                    ...
                    ;% rtP.CombinedSlipWheelCPI_ASPECT_RATIO
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 2;

                    ;% rtP.CombinedSlipWheelCPI_BOTTOM_OFFST
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;

                    ;% rtP.CombinedSlipWheelCPI_BOTTOM_STIFF
                    ...
                    ;% rtP.CombinedSlipWheelCPI_LATERAL_STIFFNESS
                    section.data(16).logicalSrcIdx = 15;
                    section.data(16).dtTransOffset = 15;

                    ;% rtP.CombinedSlipWheelCPI_LONGITUDINAL_STIFFNESS
                    ...
                    ;% rtP.CombinedSlipWheelCPI_UNLOADED_RADIUS
                    section.data(194).logicalSrcIdx = 193;
                    section.data(194).dtTransOffset = 193;

                    ;% rtP.CombinedSlipWheelCPI_VERTICAL_STIFFNESS
                    ...
                    ;% rtP.Integrator_IC_e0hvnfadm0
                    section.data(202).logicalSrcIdx = 201;
                    section.data(202).dtTransOffset = 479;

                    ;% rtP.Integrator_AbsoluteTolerance_aborjxow4z
                    ...
                    section.data(225).dtTransOffset = 502;

                    ;% rtP.Gain_Gain
                    section.data(226).logicalSrcIdx = 225;
                    section.data(226).dtTransOffset = 503;

                    ;% rtP.RadialDeflctConstant_Value
                    section.data(227).logicalSrcIdx = 226;
                    section.data(227).dtTransOffset = 504;

                    ;% rtP.vertType_Value
                    section.data(228).logicalSrcIdx = 227;
                    section.data(228).dtTransOffset = 505;
    ...
    targMap.checksum0 = 3345307469;
    targMap.checksum1 = 3392936600;
    targMap.checksum2 = 1135515161;
    targMap.checksum3 = 3115120326;
