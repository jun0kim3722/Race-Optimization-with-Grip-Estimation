...
static const _DiagnosticReport_type_support_symbol_names_t _DiagnosticReport_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deep_orange_msgs, msg, DiagnosticReport)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deep_orange_msgs, msg, DiagnosticReport)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deep_orange_msgs, msg, DiagnosticReport)() {
  return &::deep_orange_msgs::msg::rosidl_typesupport_c::DiagnosticReport_message_type_support_handle;
}
