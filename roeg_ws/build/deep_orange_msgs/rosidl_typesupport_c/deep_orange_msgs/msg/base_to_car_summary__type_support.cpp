...
static const _BaseToCarSummary_type_support_symbol_names_t _BaseToCarSummary_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deep_orange_msgs, msg, BaseToCarSummary)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deep_orange_msgs, msg, BaseToCarSummary)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deep_orange_msgs, msg, BaseToCarSummary)() {
  return &::deep_orange_msgs::msg::rosidl_typesupport_c::BaseToCarSummary_message_type_support_handle;
}
