...
#include "deep_orange_msgs/msg/detail/rc_to_ct__rosidl_typesupport_fastrtps_c.h"
...
using _RcToCt__ros_msg_type = deep_orange_msgs__msg__RcToCt;
...
size_t get_serialized_size_deep_orange_msgs__msg__RcToCt(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RcToCt__ros_msg_type * ros_message = static_cast<const _RcToCt__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RcToCt__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deep_orange_msgs__msg__RcToCt(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deep_orange_msgs
size_t max_serialized_size_deep_orange_msgs__msg__RcToCt(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_deep_orange_msgs__msg__RcToCt(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deep_orange_msgs, msg, RcToCt)() {
