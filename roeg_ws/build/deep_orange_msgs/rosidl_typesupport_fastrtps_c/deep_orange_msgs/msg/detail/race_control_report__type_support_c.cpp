...
#include "deep_orange_msgs/msg/detail/race_control_report__rosidl_typesupport_fastrtps_c.h"
...
using _RaceControlReport__ros_msg_type = deep_orange_msgs__msg__RaceControlReport;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RaceControlReport__ros_msg_type * ros_message = static_cast<const _RaceControlReport__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
  ...
  // Field name: marelli_track_flag
  {
    cdr << ros_message->marelli_track_flag;
  }

  // Field name: marelli_vehicle_flag
  {
    cdr << ros_message->marelli_vehicle_flag;
  }

  // Field name: marelli_sector_flag
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RaceControlReport__ros_msg_type * ros_message = static_cast<_RaceControlReport__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_deep_orange_msgs__msg__RaceControlReport(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RaceControlReport__ros_msg_type * ros_message = static_cast<const _RaceControlReport__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RaceControlReport__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deep_orange_msgs__msg__RaceControlReport(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deep_orange_msgs
size_t max_serialized_size_deep_orange_msgs__msg__RaceControlReport(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_deep_orange_msgs__msg__RaceControlReport(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_RaceControlReport = {
...
static rosidl_message_type_support_t _RaceControlReport__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RaceControlReport,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deep_orange_msgs, msg, RaceControlReport)() {
  return &_RaceControlReport__type_support;
}
