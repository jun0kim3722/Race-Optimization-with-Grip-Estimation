...
#include "deep_orange_msgs/msg/detail/coordinates__rosidl_typesupport_fastrtps_c.h"
...
using _Coordinates__ros_msg_type = deep_orange_msgs__msg__Coordinates;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: heading_real
  {
    cdr << ros_message->heading_real;
  }

  // Field name: heading_imag
  {
    cdr << ros_message->heading_imag;
  }
...
size_t get_serialized_size_deep_orange_msgs__msg__Coordinates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Coordinates__ros_msg_type * ros_message = static_cast<const _Coordinates__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name heading_real
  {
    size_t item_size = sizeof(ros_message->heading_real);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name heading_imag
  {
    size_t item_size = sizeof(ros_message->heading_imag);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Coordinates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deep_orange_msgs__msg__Coordinates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deep_orange_msgs
size_t max_serialized_size_deep_orange_msgs__msg__Coordinates(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_deep_orange_msgs__msg__Coordinates(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deep_orange_msgs, msg, Coordinates)() {
