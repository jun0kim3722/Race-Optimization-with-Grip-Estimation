...
#ifndef DEEP_ORANGE_MSGS__MSG__DETAIL__TIRE_REPORT__STRUCT_HPP_
#define DEEP_ORANGE_MSGS__MSG__DETAIL__TIRE_REPORT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deep_orange_msgs__msg__TireReport __attribute__((deprecated))
#else
# define DEPRECATED__deep_orange_msgs__msg__TireReport __declspec(deprecated)
#endif
...
struct TireReport_
{
  ...
  // pointer types
  using RawPtr =
    deep_orange_msgs::msg::TireReport_<ContainerAllocator> *;
  using ConstRawPtr =
    const deep_orange_msgs::msg::TireReport_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deep_orange_msgs::msg::TireReport_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deep_orange_msgs::msg::TireReport_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deep_orange_msgs::msg::TireReport_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deep_orange_msgs::msg::TireReport_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deep_orange_msgs::msg::TireReport_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deep_orange_msgs::msg::TireReport_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deep_orange_msgs::msg::TireReport_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deep_orange_msgs__msg__TireReport
    std::shared_ptr<deep_orange_msgs::msg::TireReport_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deep_orange_msgs__msg__TireReport
    std::shared_ptr<deep_orange_msgs::msg::TireReport_<ContainerAllocator> const>
...
using TireReport =
  deep_orange_msgs::msg::TireReport_<std::allocator<void>>;
...
#endif  // DEEP_ORANGE_MSGS__MSG__DETAIL__TIRE_REPORT__STRUCT_HPP_
