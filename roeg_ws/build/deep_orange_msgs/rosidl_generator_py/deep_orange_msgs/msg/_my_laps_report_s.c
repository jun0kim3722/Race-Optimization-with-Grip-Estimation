...
bool deep_orange_msgs__msg__my_laps_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deep_orange_msgs.msg._my_laps_report.MyLapsReport", full_classname_dest, 49) == 0);
  }
  deep_orange_msgs__msg__MyLapsReport * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of MyLapsReport */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deep_orange_msgs.msg._my_laps_report");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MyLapsReport");
