...
bool deep_orange_msgs__msg__misc_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deep_orange_msgs.msg._misc_report.MiscReport", full_classname_dest, 44) == 0);
  }
  deep_orange_msgs__msg__MiscReport * ros_message = _ros_message;
  {  // stamp
...
PyObject * deep_orange_msgs__msg__misc_report__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deep_orange_msgs.msg._misc_report");
