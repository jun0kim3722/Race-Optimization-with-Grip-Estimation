...
bool deep_orange_msgs__msg__marelli_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deep_orange_msgs.msg._marelli_report.MarelliReport", full_classname_dest, 50) == 0);
  }
  deep_orange_msgs__msg__MarelliReport * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of MarelliReport */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deep_orange_msgs.msg._marelli_report");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MarelliReport");
