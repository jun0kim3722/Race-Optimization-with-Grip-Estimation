...
static const _Coordinates_type_support_symbol_names_t _Coordinates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deep_orange_msgs, msg, Coordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deep_orange_msgs, msg, Coordinates)),
  }
};
...
{
  return &::deep_orange_msgs::msg::rosidl_typesupport_cpp::Coordinates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deep_orange_msgs, msg, Coordinates)() {
  return get_message_type_support_handle<deep_orange_msgs::msg::Coordinates>();
}
