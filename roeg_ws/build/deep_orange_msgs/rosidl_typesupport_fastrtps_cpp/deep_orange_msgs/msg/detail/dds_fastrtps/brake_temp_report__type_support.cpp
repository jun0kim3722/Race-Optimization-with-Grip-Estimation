...
#include "deep_orange_msgs/msg/detail/brake_temp_report__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deep_orange_msgs::msg::BrakeTempReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deep_orange_msgs::msg::BrakeTempReport & ros_message)
{
  // Member: stamp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deep_orange_msgs
max_serialized_size_BrakeTempReport(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const deep_orange_msgs::msg::BrakeTempReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deep_orange_msgs::msg::BrakeTempReport *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BrakeTempReport__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deep_orange_msgs::msg::BrakeTempReport *>(
...
{
  return max_serialized_size_BrakeTempReport(full_bounded, 0);
}

static message_type_support_callbacks_t _BrakeTempReport__callbacks = {
...
static rosidl_message_type_support_t _BrakeTempReport__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BrakeTempReport__callbacks,
...
{
  return &deep_orange_msgs::msg::typesupport_fastrtps_cpp::_BrakeTempReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deep_orange_msgs, msg, BrakeTempReport)() {
  return &deep_orange_msgs::msg::typesupport_fastrtps_cpp::_BrakeTempReport__handle;
}
