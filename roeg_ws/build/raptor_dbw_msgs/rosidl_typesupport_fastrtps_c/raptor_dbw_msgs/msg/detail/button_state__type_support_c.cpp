...
#include "raptor_dbw_msgs/msg/detail/button_state__rosidl_typesupport_fastrtps_c.h"
...
using _ButtonState__ros_msg_type = raptor_dbw_msgs__msg__ButtonState;
...
static uint32_t _ButtonState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_raptor_dbw_msgs__msg__ButtonState(
...
{
  return max_serialized_size_raptor_dbw_msgs__msg__ButtonState(
    full_bounded, 0);
}
