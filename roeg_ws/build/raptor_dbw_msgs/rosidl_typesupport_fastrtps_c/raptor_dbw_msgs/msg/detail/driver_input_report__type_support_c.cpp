  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: steer_wheel_button_a
  {
    cdr << (ros_message->steer_wheel_button_a ? true : false);
  }

  // Field name: steer_wheel_button_b
  {
    cdr << (ros_message->steer_wheel_button_b ? true : false);
  }

  // Field name: steer_wheel_button_c
  {
    cdr << (ros_message->steer_wheel_button_c ? true : false);
  }

  // Field name: steer_wheel_button_d
  {
    cdr << (ros_message->steer_wheel_button_d ? true : false);
  }

  // Field name: steer_wheel_button_e
  {
    cdr << (ros_message->steer_wheel_button_e ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: steer_wheel_button_a
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->steer_wheel_button_a = tmp ? true : false;
  }
  ...
  // Field name: steer_wheel_button_b
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->steer_wheel_button_b = tmp ? true : false;
  }
  ...
  // Field name: steer_wheel_button_c
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->steer_wheel_button_c = tmp ? true : false;
  }
  ...
  // Field name: steer_wheel_button_d
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->steer_wheel_button_d = tmp ? true : false;
  }
  ...
  // Field name: steer_wheel_button_e
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->steer_wheel_button_e = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name steer_wheel_button_a
  {
    size_t item_size = sizeof(ros_message->steer_wheel_button_a);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name steer_wheel_button_b
  {
    size_t item_size = sizeof(ros_message->steer_wheel_button_b);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name steer_wheel_button_c
  {
    size_t item_size = sizeof(ros_message->steer_wheel_button_c);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name steer_wheel_button_d
  {
    size_t item_size = sizeof(ros_message->steer_wheel_button_d);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name steer_wheel_button_e
  {
    size_t item_size = sizeof(ros_message->steer_wheel_button_e);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name driver_door_ajar
...
static size_t _DriverInputReport__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_raptor_dbw_msgs__msg__DriverInputReport(
    full_bounded, 0);
}
