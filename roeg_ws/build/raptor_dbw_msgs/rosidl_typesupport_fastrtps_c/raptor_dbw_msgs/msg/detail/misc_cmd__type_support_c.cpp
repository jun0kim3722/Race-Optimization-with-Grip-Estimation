...
#include "raptor_dbw_msgs/msg/detail/door_lock__functions.h"  // door_lock_cmd
...
{
  return max_serialized_size_raptor_dbw_msgs__msg__MiscCmd(
    full_bounded, 0);
}
