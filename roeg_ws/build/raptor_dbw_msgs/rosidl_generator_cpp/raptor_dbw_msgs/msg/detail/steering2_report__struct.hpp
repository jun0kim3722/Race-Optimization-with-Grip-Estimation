...
struct Steering2Report_
{
  ...
  : header(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->expect_torque_driver = 0.0f;
    }
  }
  ...
  using _expect_torque_driver_type =
    float;
  _expect_torque_driver_type expect_torque_driver;
  ...
  Type & set__expect_torque_driver(
    const float & _arg)
  {
    this->expect_torque_driver = _arg;
    return *this;
  }
  ...
  bool operator==(const Steering2Report_ & other) const
  {
    ...
    if (this->expect_torque_driver != other.expect_torque_driver) {
      return false;
    }
    return true;
  }
