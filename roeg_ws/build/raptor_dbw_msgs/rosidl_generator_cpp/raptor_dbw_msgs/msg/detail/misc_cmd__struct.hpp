...
struct MiscCmd_
{
  ...
  using _door_lock_cmd_type =
    raptor_dbw_msgs::msg::DoorLock_<ContainerAllocator>;
  _door_lock_cmd_type door_lock_cmd;
  ...
  bool operator==(const MiscCmd_ & other) const
  {
    ...
    if (this->door_lock_cmd != other.door_lock_cmd) {
      return false;
    }
