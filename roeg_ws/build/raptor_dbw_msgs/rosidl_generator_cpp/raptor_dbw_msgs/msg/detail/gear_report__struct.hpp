...
struct GearReport_
{
    ...
    state(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->enabled = false;
      this->trans_curr_gear = 0;
      this->gear_select_system_fault = false;
      this->gear_mismatch_flash = false;
    }
  }
  ...
  using _trans_curr_gear_type =
    uint8_t;
  _trans_curr_gear_type trans_curr_gear;
  using _gear_select_system_fault_type =
    bool;
  _gear_select_system_fault_type gear_select_system_fault;
  using _gear_mismatch_flash_type =
    bool;
  _gear_mismatch_flash_type gear_mismatch_flash;
  ...
  Type & set__trans_curr_gear(
    const uint8_t & _arg)
  {
    this->trans_curr_gear = _arg;
    return *this;
  }
  ...
  Type & set__gear_mismatch_flash(
    const bool & _arg)
  {
    this->gear_mismatch_flash = _arg;
    return *this;
  }
  ...
  bool operator==(const GearReport_ & other) const
  {
    ...
    if (this->trans_curr_gear != other.trans_curr_gear) {
      return false;
    }
    if (this->gear_select_system_fault != other.gear_select_system_fault) {
      return false;
    }
    if (this->gear_mismatch_flash != other.gear_mismatch_flash) {
      return false;
    }
    return true;
  }
