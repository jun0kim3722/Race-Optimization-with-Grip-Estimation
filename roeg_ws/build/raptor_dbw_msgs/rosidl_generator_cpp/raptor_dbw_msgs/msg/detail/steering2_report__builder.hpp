...
class Init_Steering2Report_expect_torque_driver
{
public:
  explicit Init_Steering2Report_expect_torque_driver(::raptor_dbw_msgs::msg::Steering2Report & msg)
  : msg_(msg)
  {}
  ::raptor_dbw_msgs::msg::Steering2Report expect_torque_driver(::raptor_dbw_msgs::msg::Steering2Report::_expect_torque_driver_type arg)
  {
    msg_.expect_torque_driver = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Steering2Report_expect_torque_driver max_torque_motor(::raptor_dbw_msgs::msg::Steering2Report::_max_torque_motor_type arg)
  {
    msg_.max_torque_motor = std::move(arg);
    return Init_Steering2Report_expect_torque_driver(msg_);
  }
