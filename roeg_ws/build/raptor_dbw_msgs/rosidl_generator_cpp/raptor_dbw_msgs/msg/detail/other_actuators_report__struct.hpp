...
struct OtherActuatorsReport_
{
  ...
  : header(_init),
    ...
    door_lock_state(_init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      this->turn_signal_sync = false;
  ...
  using _turn_signal_sync_type =
    bool;
  _turn_signal_sync_type turn_signal_sync;
  ...
  Type & set__turn_signal_sync(
    const bool & _arg)
  {
    this->turn_signal_sync = _arg;
    return *this;
  }
  ...
  Type & set__low_beam_state(
    const raptor_dbw_msgs::msg::LowBeamState_<ContainerAllocator> & _arg)
  {
  ...
  Type & set__door_lock_state(
    const raptor_dbw_msgs::msg::DoorLock_<ContainerAllocator> & _arg)
  {
    this->door_lock_state = _arg;
    return *this;
  }
  ...
  bool operator==(const OtherActuatorsReport_ & other) const
  {
    ...
    if (this->turn_signal_sync != other.turn_signal_sync) {
      return false;
    }
    ...
    if (this->door_lock_state != other.door_lock_state) {
      return false;
    }
