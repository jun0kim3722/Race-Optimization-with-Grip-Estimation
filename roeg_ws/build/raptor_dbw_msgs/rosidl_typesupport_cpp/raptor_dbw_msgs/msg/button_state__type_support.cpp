...
static const _ButtonState_type_support_symbol_names_t _ButtonState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raptor_dbw_msgs, msg, ButtonState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, raptor_dbw_msgs, msg, ButtonState)),
  }
};
...
{
  return &::raptor_dbw_msgs::msg::rosidl_typesupport_cpp::ButtonState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, raptor_dbw_msgs, msg, ButtonState)() {
  return get_message_type_support_handle<raptor_dbw_msgs::msg::ButtonState>();
}
