...
static const _GpsRemainderReport_type_support_symbol_names_t _GpsRemainderReport_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raptor_dbw_msgs, msg, GpsRemainderReport)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, raptor_dbw_msgs, msg, GpsRemainderReport)),
  }
};
...
{
  return &::raptor_dbw_msgs::msg::rosidl_typesupport_cpp::GpsRemainderReport_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, raptor_dbw_msgs, msg, GpsRemainderReport)() {
  return get_message_type_support_handle<raptor_dbw_msgs::msg::GpsRemainderReport>();
}
