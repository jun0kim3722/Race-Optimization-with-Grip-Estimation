...
{
bool cdr_serialize(
  const raptor_dbw_msgs::msg::DoorLock &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    raptor_dbw_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
    ros_message.door_lock_cmd, current_alignment);
  // Member: block_standard_cruise_buttons
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: door_lock_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        raptor_dbw_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DoorLock(
        full_bounded, current_alignment);
    }
  }
...
static size_t _MiscCmd__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_MiscCmd(full_bounded, 0);
}
