...
#include "raptor_dbw_msgs/msg/detail/button_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const raptor_dbw_msgs::msg::ButtonState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raptor_dbw_msgs::msg::ButtonState & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
...
{
  auto typed_message =
    static_cast<const raptor_dbw_msgs::msg::ButtonState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<raptor_dbw_msgs::msg::ButtonState *>(
    untyped_ros_message);
...
{
  return &raptor_dbw_msgs::msg::typesupport_fastrtps_cpp::_ButtonState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raptor_dbw_msgs, msg, ButtonState)() {
  return &raptor_dbw_msgs::msg::typesupport_fastrtps_cpp::_ButtonState__handle;
}
