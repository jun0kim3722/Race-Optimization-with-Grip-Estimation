...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MiscCmd_message_member_array[15] = {
  {
    "cmd",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(raptor_dbw_msgs::msg::MiscCmd, door_lock_cmd),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
