...
void BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_init_function(
...
void BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_fini_function(void * message_memory)
{
  raptor_dbw_msgs__msg__BrakeReport__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_member_array[12] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_members = {
  "raptor_dbw_msgs__msg",  // message namespace
  "BrakeReport",  // message name
  12,  // number of fields
  sizeof(raptor_dbw_msgs__msg__BrakeReport),
  BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_member_array,  // message members
  BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_init_function,  // function to initialize message memory (memory has to be allocated)
  BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_type_support_handle = {
  0,
  &BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, BrakeReport)() {
  BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_member_array[10].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, ParkingBrake)();
  BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_member_array[11].members_ =
  ...
  if (!BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_type_support_handle.typesupport_identifier) {
    BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &BrakeReport__rosidl_typesupport_introspection_c__BrakeReport_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
