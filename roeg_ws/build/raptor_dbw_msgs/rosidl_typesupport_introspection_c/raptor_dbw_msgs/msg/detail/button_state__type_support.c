  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  raptor_dbw_msgs__msg__ButtonState__init(message_memory);
}

void ButtonState__rosidl_typesupport_introspection_c__ButtonState_fini_function(void * message_memory)
{
  raptor_dbw_msgs__msg__ButtonState__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ButtonState__rosidl_typesupport_introspection_c__ButtonState_message_member_array[1] = {
  {
    "value",  // name
    ...
    offsetof(raptor_dbw_msgs__msg__ButtonState, value),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers ButtonState__rosidl_typesupport_introspection_c__ButtonState_message_members = {
  ...
  1,  // number of fields
  sizeof(raptor_dbw_msgs__msg__ButtonState),
