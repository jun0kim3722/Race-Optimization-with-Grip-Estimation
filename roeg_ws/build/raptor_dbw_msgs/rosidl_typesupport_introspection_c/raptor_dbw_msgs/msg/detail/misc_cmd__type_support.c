...
void MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_init_function(
...
void MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_fini_function(void * message_memory)
{
  raptor_dbw_msgs__msg__MiscCmd__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[15] = {
  {
    "cmd",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(raptor_dbw_msgs__msg__MiscCmd, door_lock_cmd),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_members = {
  "raptor_dbw_msgs__msg",  // message namespace
  "MiscCmd",  // message name
  15,  // number of fields
  sizeof(raptor_dbw_msgs__msg__MiscCmd),
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array,  // message members
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_init_function,  // function to initialize message memory (memory has to be allocated)
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_type_support_handle = {
  0,
  &MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, MiscCmd)() {
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, TurnSignal)();
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, DoorRequest)();
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, HighBeam)();
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[4].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, WiperFront)();
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[5].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, WiperRear)();
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[6].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, Ignition)();
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[7].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, DoorRequest)();
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[8].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, DoorRequest)();
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[9].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, DoorLock)();
  MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_member_array[14].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, LowBeam)();
  if (!MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_type_support_handle.typesupport_identifier) {
    MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &MiscCmd__rosidl_typesupport_introspection_c__MiscCmd_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
