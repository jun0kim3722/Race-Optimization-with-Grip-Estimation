...
class Metaclass_OtherActuatorsReport(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from raptor_dbw_msgs.msg import DoorLock
            if DoorLock.__class__._TYPE_SUPPORT is None:
                DoorLock.__class__.__import_type_support__()
            ...
            from raptor_dbw_msgs.msg import LowBeamState
            if LowBeamState.__class__._TYPE_SUPPORT is None:
                LowBeamState.__class__.__import_type_support__()
...
class OtherActuatorsReport(metaclass=Metaclass_OtherActuatorsReport):
    ...
    _fields_and_field_types = {
        ...
        'turn_signal_sync': 'boolean',
        'high_beam_state': 'raptor_dbw_msgs/HighBeamState',
        'low_beam_state': 'raptor_dbw_msgs/LowBeamState',
        ...
        'door_lock_state': 'raptor_dbw_msgs/DoorLock',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['raptor_dbw_msgs', 'msg'], 'LowBeamState'),  # noqa: E501
        ...
        rosidl_parser.definition.NamespacedType(['raptor_dbw_msgs', 'msg'], 'DoorState'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['raptor_dbw_msgs', 'msg'], 'DoorState'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['raptor_dbw_msgs', 'msg'], 'DoorLock'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.turn_signal_sync = kwargs.get('turn_signal_sync', bool())
        from raptor_dbw_msgs.msg import HighBeamState
        self.high_beam_state = kwargs.get('high_beam_state', HighBeamState())
        from raptor_dbw_msgs.msg import LowBeamState
        self.low_beam_state = kwargs.get('low_beam_state', LowBeamState())
        from raptor_dbw_msgs.msg import WiperFront
        ...
        from raptor_dbw_msgs.msg import DoorLock
        self.door_lock_state = kwargs.get('door_lock_state', DoorLock())
    ...
    def __eq__(self, other):
        ...
        if self.turn_signal_state != other.turn_signal_state:
            return False
        if self.turn_signal_sync != other.turn_signal_sync:
            return False
        ...
        if self.liftgate_door_state != other.liftgate_door_state:
            return False
        if self.door_lock_state != other.door_lock_state:
            return False
    ...
    @property
    def turn_signal_sync(self):
        """Message field 'turn_signal_sync'."""
        return self._turn_signal_sync

    @turn_signal_sync.setter
    def turn_signal_sync(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'turn_signal_sync' field must be of type 'bool'"
        self._turn_signal_sync = value
    ...
    def low_beam_state(self, value):
        if __debug__:
            from raptor_dbw_msgs.msg import LowBeamState
            assert \
                isinstance(value, LowBeamState), \
                "The 'low_beam_state' field must be a sub message of type 'LowBeamState'"
    ...
    @property
    def door_lock_state(self):
        """Message field 'door_lock_state'."""
        return self._door_lock_state

    @door_lock_state.setter
    def door_lock_state(self, value):
        if __debug__:
            from raptor_dbw_msgs.msg import DoorLock
            assert \
                isinstance(value, DoorLock), \
                "The 'door_lock_state' field must be a sub message of type 'DoorLock'"
        self._door_lock_state = value
