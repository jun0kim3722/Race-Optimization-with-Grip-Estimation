...
class Steering2Report(metaclass=Metaclass_Steering2Report):
    ...
    def __init__(self, **kwargs):
        ...
        self.expect_torque_driver = kwargs.get('expect_torque_driver', float())
    ...
    def __eq__(self, other):
        ...
        if self.max_torque_motor != other.max_torque_motor:
            return False
        if self.expect_torque_driver != other.expect_torque_driver:
            return False
        return True
    ...
    @property
    def expect_torque_driver(self):
        """Message field 'expect_torque_driver'."""
        return self._expect_torque_driver

    @expect_torque_driver.setter
    def expect_torque_driver(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'expect_torque_driver' field must be of type 'float'"
        self._expect_torque_driver = value
