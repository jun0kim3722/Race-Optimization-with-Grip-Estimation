...
class Metaclass_Gear(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'AUTO_SHIFT_UP': cls.__constants['AUTO_SHIFT_UP'],
            'AUTO_SHIFT_DOWN': cls.__constants['AUTO_SHIFT_DOWN'],
        }
    ...
    def AUTO_HOLD(self):
        ...
        return Metaclass_Gear.__constants['AUTO_HOLD']

    @property
    def AUTO_SHIFT_UP(self):
        """Message constant 'AUTO_SHIFT_UP'."""
        return Metaclass_Gear.__constants['AUTO_SHIFT_UP']

    @property
    def AUTO_SHIFT_DOWN(self):
        """Message constant 'AUTO_SHIFT_DOWN'."""
        return Metaclass_Gear.__constants['AUTO_SHIFT_DOWN']
