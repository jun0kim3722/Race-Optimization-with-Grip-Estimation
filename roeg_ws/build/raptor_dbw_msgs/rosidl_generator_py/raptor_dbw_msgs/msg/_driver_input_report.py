...
class DriverInputReport(metaclass=Metaclass_DriverInputReport):
    ...
    __slots__ = [
        ...
        '_steer_wheel_button_a',
        '_steer_wheel_button_b',
        '_steer_wheel_button_c',
        '_steer_wheel_button_d',
        '_steer_wheel_button_e',
        '_driver_door_ajar',
    ...
    _fields_and_field_types = {
        ...
        'steer_wheel_button_a': 'boolean',
        'steer_wheel_button_b': 'boolean',
        'steer_wheel_button_c': 'boolean',
        'steer_wheel_button_d': 'boolean',
        'steer_wheel_button_e': 'boolean',
    ...
    def __init__(self, **kwargs):
        ...
        self.steer_wheel_button_a = kwargs.get('steer_wheel_button_a', bool())
        self.steer_wheel_button_b = kwargs.get('steer_wheel_button_b', bool())
        self.steer_wheel_button_c = kwargs.get('steer_wheel_button_c', bool())
        self.steer_wheel_button_d = kwargs.get('steer_wheel_button_d', bool())
        self.steer_wheel_button_e = kwargs.get('steer_wheel_button_e', bool())
    ...
    def __eq__(self, other):
        ...
        if self.adaptive_cruise_decrease_distance_button != other.adaptive_cruise_decrease_distance_button:
            return False
        if self.steer_wheel_button_a != other.steer_wheel_button_a:
            return False
        if self.steer_wheel_button_b != other.steer_wheel_button_b:
            return False
        if self.steer_wheel_button_c != other.steer_wheel_button_c:
            return False
        if self.steer_wheel_button_d != other.steer_wheel_button_d:
            return False
        if self.steer_wheel_button_e != other.steer_wheel_button_e:
            return False
    ...
    @property
    def steer_wheel_button_a(self):
        """Message field 'steer_wheel_button_a'."""
        return self._steer_wheel_button_a

    @steer_wheel_button_a.setter
    def steer_wheel_button_a(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'steer_wheel_button_a' field must be of type 'bool'"
        self._steer_wheel_button_a = value

    @property
    def steer_wheel_button_b(self):
        """Message field 'steer_wheel_button_b'."""
        return self._steer_wheel_button_b

    @steer_wheel_button_b.setter
    def steer_wheel_button_b(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'steer_wheel_button_b' field must be of type 'bool'"
        self._steer_wheel_button_b = value

    @property
    def steer_wheel_button_c(self):
        """Message field 'steer_wheel_button_c'."""
        return self._steer_wheel_button_c

    @steer_wheel_button_c.setter
    def steer_wheel_button_c(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'steer_wheel_button_c' field must be of type 'bool'"
        self._steer_wheel_button_c = value

    @property
    def steer_wheel_button_d(self):
        """Message field 'steer_wheel_button_d'."""
        return self._steer_wheel_button_d

    @steer_wheel_button_d.setter
    def steer_wheel_button_d(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'steer_wheel_button_d' field must be of type 'bool'"
        self._steer_wheel_button_d = value

    @property
    def steer_wheel_button_e(self):
        """Message field 'steer_wheel_button_e'."""
        return self._steer_wheel_button_e

    @steer_wheel_button_e.setter
    def steer_wheel_button_e(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'steer_wheel_button_e' field must be of type 'bool'"
        self._steer_wheel_button_e = value
