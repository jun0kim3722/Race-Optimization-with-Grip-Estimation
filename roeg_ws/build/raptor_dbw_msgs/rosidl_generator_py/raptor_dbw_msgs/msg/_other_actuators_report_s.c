...
bool raptor_dbw_msgs__msg__low_beam_state__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool raptor_dbw_msgs__msg__door_state__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * raptor_dbw_msgs__msg__door_state__convert_to_py(void * raw_ros_message);
bool raptor_dbw_msgs__msg__door_lock__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool raptor_dbw_msgs__msg__other_actuators_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // turn_signal_sync
    PyObject * field = PyObject_GetAttrString(_pymsg, "turn_signal_sync");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->turn_signal_sync = (Py_True == field);
    Py_DECREF(field);
  }
  {  // high_beam_state
  ...
  {  // low_beam_state
    ...
    if (!raptor_dbw_msgs__msg__low_beam_state__convert_from_py(field, &ros_message->low_beam_state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // door_lock_state
    PyObject * field = PyObject_GetAttrString(_pymsg, "door_lock_state");
    if (!field) {
      return false;
    }
    if (!raptor_dbw_msgs__msg__door_lock__convert_from_py(field, &ros_message->door_lock_state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * raptor_dbw_msgs__msg__other_actuators_report__convert_to_py(void * raw_ros_message)
{
  ...
  {  // turn_signal_sync
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->turn_signal_sync ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "turn_signal_sync", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // low_beam_state
    PyObject * field = NULL;
    field = raptor_dbw_msgs__msg__low_beam_state__convert_to_py(&ros_message->low_beam_state);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // door_lock_state
    PyObject * field = NULL;
    field = raptor_dbw_msgs__msg__door_lock__convert_to_py(&ros_message->door_lock_state);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "door_lock_state", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
