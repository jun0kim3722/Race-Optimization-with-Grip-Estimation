...
bool raptor_dbw_msgs__msg__button_state__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool raptor_dbw_msgs__msg__fault_actions_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // chime_fcw_beeps
    PyObject * field = PyObject_GetAttrString(_pymsg, "chime_fcw_beeps");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->chime_fcw_beeps = (Py_True == field);
    Py_DECREF(field);
  }
  {  // last_active_fault_idx
    PyObject * field = PyObject_GetAttrString(_pymsg, "last_active_fault_idx");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->last_active_fault_idx = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // estop_btn_pressed
    PyObject * field = PyObject_GetAttrString(_pymsg, "estop_btn_pressed");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->estop_btn_pressed = (Py_True == field);
    Py_DECREF(field);
  }
  {  // remote_estop_btn_pressed
    PyObject * field = PyObject_GetAttrString(_pymsg, "remote_estop_btn_pressed");
    if (!field) {
      return false;
    }
    if (!raptor_dbw_msgs__msg__button_state__convert_from_py(field, &ros_message->remote_estop_btn_pressed)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * raptor_dbw_msgs__msg__fault_actions_report__convert_to_py(void * raw_ros_message)
{
  ...
  {  // chime_fcw_beeps
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->chime_fcw_beeps ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "chime_fcw_beeps", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // last_active_fault_idx
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->last_active_fault_idx);
    {
      int rc = PyObject_SetAttrString(_pymessage, "last_active_fault_idx", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // estop_btn_pressed
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->estop_btn_pressed ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "estop_btn_pressed", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // remote_estop_btn_pressed
    PyObject * field = NULL;
    field = raptor_dbw_msgs__msg__button_state__convert_to_py(&ros_message->remote_estop_btn_pressed);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "remote_estop_btn_pressed", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
