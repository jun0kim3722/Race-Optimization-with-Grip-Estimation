...
raptor_dbw_msgs__msg__DriverInputReport__are_equal(const raptor_dbw_msgs__msg__DriverInputReport * lhs, const raptor_dbw_msgs__msg__DriverInputReport * rhs)
{
  ...
  // steer_wheel_button_a
  if (lhs->steer_wheel_button_a != rhs->steer_wheel_button_a) {
    return false;
  }
  // steer_wheel_button_b
  if (lhs->steer_wheel_button_b != rhs->steer_wheel_button_b) {
    return false;
  }
  // steer_wheel_button_c
  if (lhs->steer_wheel_button_c != rhs->steer_wheel_button_c) {
    return false;
  }
  // steer_wheel_button_d
  if (lhs->steer_wheel_button_d != rhs->steer_wheel_button_d) {
    return false;
  }
  // steer_wheel_button_e
  if (lhs->steer_wheel_button_e != rhs->steer_wheel_button_e) {
    return false;
  }
  // driver_door_ajar
  ...
  raptor_dbw_msgs__msg__DriverInputReport * output)
{
  ...
  // steer_wheel_button_a
  output->steer_wheel_button_a = input->steer_wheel_button_a;
  // steer_wheel_button_b
  output->steer_wheel_button_b = input->steer_wheel_button_b;
  // steer_wheel_button_c
  output->steer_wheel_button_c = input->steer_wheel_button_c;
  // steer_wheel_button_d
  output->steer_wheel_button_d = input->steer_wheel_button_d;
  // steer_wheel_button_e
  output->steer_wheel_button_e = input->steer_wheel_button_e;
  // driver_door_ajar
...
{
  raptor_dbw_msgs__msg__DriverInputReport * msg = (raptor_dbw_msgs__msg__DriverInputReport *)malloc(sizeof(raptor_dbw_msgs__msg__DriverInputReport));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__DriverInputReport__Sequence__init(raptor_dbw_msgs__msg__DriverInputReport__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__DriverInputReport *)calloc(size, sizeof(raptor_dbw_msgs__msg__DriverInputReport));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__DriverInputReport__Sequence * array = (raptor_dbw_msgs__msg__DriverInputReport__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__DriverInputReport__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__DriverInputReport__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__DriverInputReport * data =
      (raptor_dbw_msgs__msg__DriverInputReport *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__DriverInputReport__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__DriverInputReport__fini(&data[i]);
        }
        free(data);
        return false;
      }
