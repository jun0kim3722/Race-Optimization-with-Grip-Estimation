...
enum
{
  raptor_dbw_msgs__msg__Gear__AUTO_HOLD = 6
};

/// Constant 'AUTO_SHIFT_UP'.
enum
{
  raptor_dbw_msgs__msg__Gear__AUTO_SHIFT_UP = 7
};

/// Constant 'AUTO_SHIFT_DOWN'.
enum
{
  raptor_dbw_msgs__msg__Gear__AUTO_SHIFT_DOWN = 8
};
