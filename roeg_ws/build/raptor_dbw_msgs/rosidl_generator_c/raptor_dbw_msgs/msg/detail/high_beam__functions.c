...
{
  raptor_dbw_msgs__msg__HighBeam * msg = (raptor_dbw_msgs__msg__HighBeam *)malloc(sizeof(raptor_dbw_msgs__msg__HighBeam));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__HighBeam__Sequence__init(raptor_dbw_msgs__msg__HighBeam__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__HighBeam *)calloc(size, sizeof(raptor_dbw_msgs__msg__HighBeam));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__HighBeam__Sequence * array = (raptor_dbw_msgs__msg__HighBeam__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__HighBeam__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__HighBeam__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__HighBeam * data =
      (raptor_dbw_msgs__msg__HighBeam *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__HighBeam__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__HighBeam__fini(&data[i]);
        }
        free(data);
        return false;
      }
