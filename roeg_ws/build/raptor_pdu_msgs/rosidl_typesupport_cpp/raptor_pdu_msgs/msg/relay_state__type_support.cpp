...
static const _RelayState_type_support_symbol_names_t _RelayState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raptor_pdu_msgs, msg, RelayState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, raptor_pdu_msgs, msg, RelayState)),
  }
};
...
{
  return &::raptor_pdu_msgs::msg::rosidl_typesupport_cpp::RelayState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, raptor_pdu_msgs, msg, RelayState)() {
  return get_message_type_support_handle<raptor_pdu_msgs::msg::RelayState>();
}
