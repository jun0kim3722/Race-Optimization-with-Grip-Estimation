...
bool raptor_pdu_msgs__msg__relay_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("raptor_pdu_msgs.msg._relay_status.RelayStatus", full_classname_dest, 45) == 0);
  }
  raptor_pdu_msgs__msg__RelayStatus * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RelayStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("raptor_pdu_msgs.msg._relay_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RelayStatus");
