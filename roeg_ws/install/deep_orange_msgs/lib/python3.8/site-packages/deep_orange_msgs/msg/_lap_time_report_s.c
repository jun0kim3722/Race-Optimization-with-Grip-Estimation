...
bool deep_orange_msgs__msg__lap_time_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deep_orange_msgs.msg._lap_time_report.LapTimeReport", full_classname_dest, 51) == 0);
  }
  deep_orange_msgs__msg__LapTimeReport * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of LapTimeReport */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deep_orange_msgs.msg._lap_time_report");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LapTimeReport");
