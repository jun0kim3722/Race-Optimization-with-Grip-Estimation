...
bool deep_orange_msgs__msg__rc_to_ct__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deep_orange_msgs.msg._rc_to_ct.RcToCt", full_classname_dest, 37) == 0);
  }
  deep_orange_msgs__msg__RcToCt * ros_message = _ros_message;
  {  // stamp
...
PyObject * deep_orange_msgs__msg__rc_to_ct__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deep_orange_msgs.msg._rc_to_ct");
