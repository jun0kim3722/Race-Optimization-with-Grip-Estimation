    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deep_orange_msgs.msg.TireReport')
            logger.debug(
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'fl_tire_temperature' field must be a set or sequence and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'fr_tire_temperature' field must be a set or sequence and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'rl_tire_temperature' field must be a set or sequence and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'rr_tire_temperature' field must be a set or sequence and each value of type 'float'"
