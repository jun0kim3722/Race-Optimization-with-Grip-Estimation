...
{
  new (message_memory) raptor_dbw_msgs::msg::ButtonState(_init);
}

void ButtonState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<raptor_dbw_msgs::msg::ButtonState *>(message_memory);
  typed_message->~ButtonState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ButtonState_message_member_array[1] = {
  {
    "value",  // name
    ...
    offsetof(raptor_dbw_msgs::msg::ButtonState, value),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ButtonState_message_members = {
  ...
  1,  // number of fields
  sizeof(raptor_dbw_msgs::msg::ButtonState),
...
get_message_type_support_handle<raptor_dbw_msgs::msg::ButtonState>()
{
  return &::raptor_dbw_msgs::msg::rosidl_typesupport_introspection_cpp::ButtonState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, raptor_dbw_msgs, msg, ButtonState)() {
  return &::raptor_dbw_msgs::msg::rosidl_typesupport_introspection_cpp::ButtonState_message_type_support_handle;
}
