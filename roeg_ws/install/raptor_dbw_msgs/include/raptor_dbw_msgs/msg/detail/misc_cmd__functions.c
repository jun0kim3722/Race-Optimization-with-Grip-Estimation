...
raptor_dbw_msgs__msg__MiscCmd__init(raptor_dbw_msgs__msg__MiscCmd * msg)
{
  ...
  // door_lock_cmd
  if (!raptor_dbw_msgs__msg__DoorLock__init(&msg->door_lock_cmd)) {
    raptor_dbw_msgs__msg__MiscCmd__fini(msg);
    return false;
  }
...
raptor_dbw_msgs__msg__MiscCmd__fini(raptor_dbw_msgs__msg__MiscCmd * msg)
{
  ...
  // door_lock_cmd
  raptor_dbw_msgs__msg__DoorLock__fini(&msg->door_lock_cmd);
  // block_standard_cruise_buttons
  // block_adaptive_cruise_buttons
  // block_turn_signal_stalk
  // horn_cmd
...
raptor_dbw_msgs__msg__MiscCmd__are_equal(const raptor_dbw_msgs__msg__MiscCmd * lhs, const raptor_dbw_msgs__msg__MiscCmd * rhs)
{
  ...
  if (!raptor_dbw_msgs__msg__DoorLock__are_equal(
      &(lhs->door_lock_cmd), &(rhs->door_lock_cmd)))
  {
    return false;
  }
  // block_standard_cruise_buttons
  ...
  raptor_dbw_msgs__msg__MiscCmd * output)
{
  ...
  if (!raptor_dbw_msgs__msg__DoorLock__copy(
      &(input->door_lock_cmd), &(output->door_lock_cmd)))
  {
    return false;
  }
  // block_standard_cruise_buttons
...
{
  raptor_dbw_msgs__msg__MiscCmd * msg = (raptor_dbw_msgs__msg__MiscCmd *)malloc(sizeof(raptor_dbw_msgs__msg__MiscCmd));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__MiscCmd__Sequence__init(raptor_dbw_msgs__msg__MiscCmd__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__MiscCmd *)calloc(size, sizeof(raptor_dbw_msgs__msg__MiscCmd));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__MiscCmd__Sequence * array = (raptor_dbw_msgs__msg__MiscCmd__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__MiscCmd__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__MiscCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__MiscCmd * data =
      (raptor_dbw_msgs__msg__MiscCmd *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__MiscCmd__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__MiscCmd__fini(&data[i]);
        }
        free(data);
        return false;
      }
