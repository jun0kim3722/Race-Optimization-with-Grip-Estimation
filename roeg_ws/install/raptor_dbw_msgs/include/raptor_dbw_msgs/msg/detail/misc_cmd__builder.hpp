...
class Init_MiscCmd_door_lock_cmd
{
public:
  explicit Init_MiscCmd_door_lock_cmd(::raptor_dbw_msgs::msg::MiscCmd & msg)
  : msg_(msg)
  {}
  Init_MiscCmd_block_standard_cruise_buttons door_lock_cmd(::raptor_dbw_msgs::msg::MiscCmd::_door_lock_cmd_type arg)
  {
    msg_.door_lock_cmd = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_MiscCmd_door_lock_cmd door_request_lift_gate(::raptor_dbw_msgs::msg::MiscCmd::_door_request_lift_gate_type arg)
  {
    msg_.door_request_lift_gate = std::move(arg);
    return Init_MiscCmd_door_lock_cmd(msg_);
  }
