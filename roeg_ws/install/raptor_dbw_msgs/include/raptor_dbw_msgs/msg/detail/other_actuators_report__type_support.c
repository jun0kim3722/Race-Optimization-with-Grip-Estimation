...
#include "raptor_dbw_msgs/msg/low_beam_state.h"
// Member `low_beam_state`
#include "raptor_dbw_msgs/msg/detail/low_beam_state__rosidl_typesupport_introspection_c.h"
...
#include "raptor_dbw_msgs/msg/door_lock.h"
// Member `door_lock_state`
#include "raptor_dbw_msgs/msg/detail/door_lock__rosidl_typesupport_introspection_c.h"
...
void OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_init_function(
...
void OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_fini_function(void * message_memory)
{
  raptor_dbw_msgs__msg__OtherActuatorsReport__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[14] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(raptor_dbw_msgs__msg__OtherActuatorsReport, turn_signal_sync),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(raptor_dbw_msgs__msg__OtherActuatorsReport, door_lock_state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_members = {
  "raptor_dbw_msgs__msg",  // message namespace
  "OtherActuatorsReport",  // message name
  14,  // number of fields
  sizeof(raptor_dbw_msgs__msg__OtherActuatorsReport),
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array,  // message members
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_init_function,  // function to initialize message memory (memory has to be allocated)
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_type_support_handle = {
  0,
  &OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, OtherActuatorsReport)() {
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, Ignition)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, HornState)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, TurnSignal)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[5].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, HighBeamState)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[6].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, LowBeamState)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[7].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, WiperFront)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[8].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, WiperRear)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[9].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, DoorState)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[10].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, DoorState)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[11].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, DoorState)();
  OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_member_array[12].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, DoorLock)();
  if (!OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_type_support_handle.typesupport_identifier) {
    OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &OtherActuatorsReport__rosidl_typesupport_introspection_c__OtherActuatorsReport_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
