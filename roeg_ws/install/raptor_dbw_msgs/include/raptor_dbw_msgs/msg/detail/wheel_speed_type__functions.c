...
{
  raptor_dbw_msgs__msg__WheelSpeedType * msg = (raptor_dbw_msgs__msg__WheelSpeedType *)malloc(sizeof(raptor_dbw_msgs__msg__WheelSpeedType));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__WheelSpeedType__Sequence__init(raptor_dbw_msgs__msg__WheelSpeedType__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__WheelSpeedType *)calloc(size, sizeof(raptor_dbw_msgs__msg__WheelSpeedType));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__WheelSpeedType__Sequence * array = (raptor_dbw_msgs__msg__WheelSpeedType__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__WheelSpeedType__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__WheelSpeedType__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__WheelSpeedType * data =
      (raptor_dbw_msgs__msg__WheelSpeedType *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__WheelSpeedType__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__WheelSpeedType__fini(&data[i]);
        }
        free(data);
        return false;
      }
