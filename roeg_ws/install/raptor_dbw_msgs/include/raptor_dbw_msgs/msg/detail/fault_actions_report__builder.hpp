...
class Init_FaultActionsReport_remote_estop_btn_pressed
{
public:
  explicit Init_FaultActionsReport_remote_estop_btn_pressed(::raptor_dbw_msgs::msg::FaultActionsReport & msg)
  : msg_(msg)
  {}
  ::raptor_dbw_msgs::msg::FaultActionsReport remote_estop_btn_pressed(::raptor_dbw_msgs::msg::FaultActionsReport::_remote_estop_btn_pressed_type arg)
  {
    msg_.remote_estop_btn_pressed = std::move(arg);
...
class Init_FaultActionsReport_estop_btn_pressed
{
public:
  explicit Init_FaultActionsReport_estop_btn_pressed(::raptor_dbw_msgs::msg::FaultActionsReport & msg)
  : msg_(msg)
  {}
  Init_FaultActionsReport_remote_estop_btn_pressed estop_btn_pressed(::raptor_dbw_msgs::msg::FaultActionsReport::_estop_btn_pressed_type arg)
  {
    msg_.estop_btn_pressed = std::move(arg);
    return Init_FaultActionsReport_remote_estop_btn_pressed(msg_);
  }
...
class Init_FaultActionsReport_last_active_fault_idx
{
public:
  explicit Init_FaultActionsReport_last_active_fault_idx(::raptor_dbw_msgs::msg::FaultActionsReport & msg)
  : msg_(msg)
  {}
  Init_FaultActionsReport_estop_btn_pressed last_active_fault_idx(::raptor_dbw_msgs::msg::FaultActionsReport::_last_active_fault_idx_type arg)
  {
    msg_.last_active_fault_idx = std::move(arg);
    return Init_FaultActionsReport_estop_btn_pressed(msg_);
  }
...
class Init_FaultActionsReport_chime_fcw_beeps
{
public:
  explicit Init_FaultActionsReport_chime_fcw_beeps(::raptor_dbw_msgs::msg::FaultActionsReport & msg)
  : msg_(msg)
  {}
  Init_FaultActionsReport_last_active_fault_idx chime_fcw_beeps(::raptor_dbw_msgs::msg::FaultActionsReport::_chime_fcw_beeps_type arg)
  {
    msg_.chime_fcw_beeps = std::move(arg);
    return Init_FaultActionsReport_last_active_fault_idx(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_FaultActionsReport_chime_fcw_beeps warn_driver_only(::raptor_dbw_msgs::msg::FaultActionsReport::_warn_driver_only_type arg)
  {
    msg_.warn_driver_only = std::move(arg);
    return Init_FaultActionsReport_chime_fcw_beeps(msg_);
  }
