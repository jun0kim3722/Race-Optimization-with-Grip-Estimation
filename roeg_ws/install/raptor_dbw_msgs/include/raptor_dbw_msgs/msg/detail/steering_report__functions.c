...
{
  raptor_dbw_msgs__msg__SteeringReport * msg = (raptor_dbw_msgs__msg__SteeringReport *)malloc(sizeof(raptor_dbw_msgs__msg__SteeringReport));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__SteeringReport__Sequence__init(raptor_dbw_msgs__msg__SteeringReport__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__SteeringReport *)calloc(size, sizeof(raptor_dbw_msgs__msg__SteeringReport));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__SteeringReport__Sequence * array = (raptor_dbw_msgs__msg__SteeringReport__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__SteeringReport__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__SteeringReport__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__SteeringReport * data =
      (raptor_dbw_msgs__msg__SteeringReport *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__SteeringReport__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__SteeringReport__fini(&data[i]);
        }
        free(data);
        return false;
      }
