...
{
  raptor_dbw_msgs__msg__SurroundReport * msg = (raptor_dbw_msgs__msg__SurroundReport *)malloc(sizeof(raptor_dbw_msgs__msg__SurroundReport));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__SurroundReport__Sequence__init(raptor_dbw_msgs__msg__SurroundReport__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__SurroundReport *)calloc(size, sizeof(raptor_dbw_msgs__msg__SurroundReport));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__SurroundReport__Sequence * array = (raptor_dbw_msgs__msg__SurroundReport__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__SurroundReport__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__SurroundReport__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__SurroundReport * data =
      (raptor_dbw_msgs__msg__SurroundReport *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__SurroundReport__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__SurroundReport__fini(&data[i]);
        }
        free(data);
        return false;
      }
