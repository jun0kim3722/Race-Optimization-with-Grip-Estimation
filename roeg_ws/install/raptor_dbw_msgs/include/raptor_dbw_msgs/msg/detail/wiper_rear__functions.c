...
{
  raptor_dbw_msgs__msg__WiperRear * msg = (raptor_dbw_msgs__msg__WiperRear *)malloc(sizeof(raptor_dbw_msgs__msg__WiperRear));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__WiperRear__Sequence__init(raptor_dbw_msgs__msg__WiperRear__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__WiperRear *)calloc(size, sizeof(raptor_dbw_msgs__msg__WiperRear));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__WiperRear__Sequence * array = (raptor_dbw_msgs__msg__WiperRear__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__WiperRear__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__WiperRear__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__WiperRear * data =
      (raptor_dbw_msgs__msg__WiperRear *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__WiperRear__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__WiperRear__fini(&data[i]);
        }
        free(data);
        return false;
      }
