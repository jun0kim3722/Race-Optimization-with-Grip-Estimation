...
{
  raptor_dbw_msgs__msg__Ignition * msg = (raptor_dbw_msgs__msg__Ignition *)malloc(sizeof(raptor_dbw_msgs__msg__Ignition));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__Ignition__Sequence__init(raptor_dbw_msgs__msg__Ignition__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__Ignition *)calloc(size, sizeof(raptor_dbw_msgs__msg__Ignition));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__Ignition__Sequence * array = (raptor_dbw_msgs__msg__Ignition__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__Ignition__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__Ignition__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__Ignition * data =
      (raptor_dbw_msgs__msg__Ignition *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__Ignition__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__Ignition__fini(&data[i]);
        }
        free(data);
        return false;
      }
