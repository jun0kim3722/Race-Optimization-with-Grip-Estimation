...
{
  raptor_dbw_msgs__msg__MiscReport * msg = (raptor_dbw_msgs__msg__MiscReport *)malloc(sizeof(raptor_dbw_msgs__msg__MiscReport));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__MiscReport__Sequence__init(raptor_dbw_msgs__msg__MiscReport__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__MiscReport *)calloc(size, sizeof(raptor_dbw_msgs__msg__MiscReport));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__MiscReport__Sequence * array = (raptor_dbw_msgs__msg__MiscReport__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__MiscReport__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__MiscReport__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__MiscReport * data =
      (raptor_dbw_msgs__msg__MiscReport *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__MiscReport__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__MiscReport__fini(&data[i]);
        }
        free(data);
        return false;
      }
