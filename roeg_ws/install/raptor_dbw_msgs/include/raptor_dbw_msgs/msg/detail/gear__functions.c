...
{
  raptor_dbw_msgs__msg__Gear * msg = (raptor_dbw_msgs__msg__Gear *)malloc(sizeof(raptor_dbw_msgs__msg__Gear));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__Gear__Sequence__init(raptor_dbw_msgs__msg__Gear__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__Gear *)calloc(size, sizeof(raptor_dbw_msgs__msg__Gear));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__Gear__Sequence * array = (raptor_dbw_msgs__msg__Gear__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__Gear__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__Gear__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__Gear * data =
      (raptor_dbw_msgs__msg__Gear *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__Gear__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__Gear__fini(&data[i]);
        }
        free(data);
        return false;
      }
