...
{
  raptor_dbw_msgs__msg__AcceleratorPedalReport * msg = (raptor_dbw_msgs__msg__AcceleratorPedalReport *)malloc(sizeof(raptor_dbw_msgs__msg__AcceleratorPedalReport));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__AcceleratorPedalReport__Sequence__init(raptor_dbw_msgs__msg__AcceleratorPedalReport__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__AcceleratorPedalReport *)calloc(size, sizeof(raptor_dbw_msgs__msg__AcceleratorPedalReport));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__AcceleratorPedalReport__Sequence * array = (raptor_dbw_msgs__msg__AcceleratorPedalReport__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__AcceleratorPedalReport__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__AcceleratorPedalReport__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__AcceleratorPedalReport * data =
      (raptor_dbw_msgs__msg__AcceleratorPedalReport *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__AcceleratorPedalReport__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__AcceleratorPedalReport__fini(&data[i]);
        }
        free(data);
        return false;
      }
