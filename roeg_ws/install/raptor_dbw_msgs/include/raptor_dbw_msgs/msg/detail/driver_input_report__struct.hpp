...
struct DriverInputReport_
{
    ...
    wiper(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->steer_wheel_button_a = false;
      this->steer_wheel_button_b = false;
      this->steer_wheel_button_c = false;
      this->steer_wheel_button_d = false;
      this->steer_wheel_button_e = false;
  ...
  using _steer_wheel_button_a_type =
    bool;
  _steer_wheel_button_a_type steer_wheel_button_a;
  using _steer_wheel_button_b_type =
    bool;
  _steer_wheel_button_b_type steer_wheel_button_b;
  using _steer_wheel_button_c_type =
    bool;
  _steer_wheel_button_c_type steer_wheel_button_c;
  using _steer_wheel_button_d_type =
    bool;
  _steer_wheel_button_d_type steer_wheel_button_d;
  using _steer_wheel_button_e_type =
    bool;
  _steer_wheel_button_e_type steer_wheel_button_e;
  ...
  Type & set__steer_wheel_button_a(
    const bool & _arg)
  {
    this->steer_wheel_button_a = _arg;
    return *this;
  }
  Type & set__steer_wheel_button_b(
    const bool & _arg)
  {
    this->steer_wheel_button_b = _arg;
    return *this;
  }
  Type & set__steer_wheel_button_c(
    const bool & _arg)
  {
    this->steer_wheel_button_c = _arg;
    return *this;
  }
  Type & set__steer_wheel_button_d(
    const bool & _arg)
  {
    this->steer_wheel_button_d = _arg;
    return *this;
  }
  Type & set__steer_wheel_button_e(
    const bool & _arg)
  {
    this->steer_wheel_button_e = _arg;
    return *this;
  }
  ...
  bool operator==(const DriverInputReport_ & other) const
  {
    ...
    if (this->steer_wheel_button_a != other.steer_wheel_button_a) {
      return false;
    }
    if (this->steer_wheel_button_b != other.steer_wheel_button_b) {
      return false;
    }
    if (this->steer_wheel_button_c != other.steer_wheel_button_c) {
      return false;
    }
    if (this->steer_wheel_button_d != other.steer_wheel_button_d) {
      return false;
    }
    if (this->steer_wheel_button_e != other.steer_wheel_button_e) {
      return false;
    }
