...
class Init_Brake2Report_brake_pressure
{
public:
  explicit Init_Brake2Report_brake_pressure(::raptor_dbw_msgs::msg::Brake2Report & msg)
  : msg_(msg)
  {}
  Init_Brake2Report_estimated_road_slope brake_pressure(::raptor_dbw_msgs::msg::Brake2Report::_brake_pressure_type arg)
  {
    msg_.brake_pressure = std::move(arg);
...
public:
  ...
  {}
  Init_Brake2Report_brake_pressure header(::raptor_dbw_msgs::msg::Brake2Report::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_Brake2Report_brake_pressure(msg_);
  }
