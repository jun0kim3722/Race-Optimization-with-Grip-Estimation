...
{
  raptor_dbw_msgs__msg__WiperFront * msg = (raptor_dbw_msgs__msg__WiperFront *)malloc(sizeof(raptor_dbw_msgs__msg__WiperFront));
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__WiperFront__Sequence__init(raptor_dbw_msgs__msg__WiperFront__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__WiperFront *)calloc(size, sizeof(raptor_dbw_msgs__msg__WiperFront));
    if (!data) {
      return false;
    }
...
{
  raptor_dbw_msgs__msg__WiperFront__Sequence * array = (raptor_dbw_msgs__msg__WiperFront__Sequence *)malloc(sizeof(raptor_dbw_msgs__msg__WiperFront__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__WiperFront__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__WiperFront * data =
      (raptor_dbw_msgs__msg__WiperFront *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__WiperFront__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__WiperFront__fini(&data[i]);
        }
        free(data);
        return false;
      }
