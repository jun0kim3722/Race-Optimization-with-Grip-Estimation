  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: drive_by_wire_enabled
  {
    ...
    value_to_yaml(msg.drive_by_wire_enabled, out);
    out << "\n";
  }
  ...
  // member: software_build_number
  {
    ...
    value_to_yaml(msg.software_build_number, out);
    out << "\n";
  }
  ...
  // member: general_actuator_fault
  {
    ...
    value_to_yaml(msg.general_actuator_fault, out);
    out << "\n";
  }
  ...
  // member: by_wire_ready
  {
    ...
    out << "by_wire_ready: ";
    value_to_yaml(msg.by_wire_ready, out);
    out << "\n";
  }
  ...
  // member: general_driver_activity
  {
    ...
    value_to_yaml(msg.general_driver_activity, out);
    out << "\n";
  }
  ...
  // member: comms_fault
  {
    ...
    out << "comms_fault: ";
    value_to_yaml(msg.comms_fault, out);
    out << "\n";
  }
  ...
  // member: ambient_temp
  {
    ...
    out << "ambient_temp: ";
    value_to_yaml(msg.ambient_temp, out);
    out << "\n";
  }
