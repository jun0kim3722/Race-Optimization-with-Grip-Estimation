...
class MiscCmd(metaclass=Metaclass_MiscCmd):
    ...
    _fields_and_field_types = {
        ...
        'door_lock_cmd': 'raptor_dbw_msgs/DoorLock',
    ...
    def __init__(self, **kwargs):
        ...
        from raptor_dbw_msgs.msg import DoorLock
        self.door_lock_cmd = kwargs.get('door_lock_cmd', DoorLock())
    ...
    def __eq__(self, other):
        ...
        if self.door_request_lift_gate != other.door_request_lift_gate:
            return False
        if self.door_lock_cmd != other.door_lock_cmd:
            return False
    ...
    @property
    def door_lock_cmd(self):
        """Message field 'door_lock_cmd'."""
        return self._door_lock_cmd

    @door_lock_cmd.setter
    def door_lock_cmd(self, value):
        if __debug__:
            from raptor_dbw_msgs.msg import DoorLock
            assert \
                isinstance(value, DoorLock), \
                "The 'door_lock_cmd' field must be a sub message of type 'DoorLock'"
        self._door_lock_cmd = value
