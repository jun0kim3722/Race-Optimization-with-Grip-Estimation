...
bool raptor_dbw_msgs__msg__misc_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // door_lock_cmd
    PyObject * field = PyObject_GetAttrString(_pymsg, "door_lock_cmd");
    if (!field) {
      return false;
    }
    if (!raptor_dbw_msgs__msg__door_lock__convert_from_py(field, &ros_message->door_lock_cmd)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * raptor_dbw_msgs__msg__misc_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {  // door_lock_cmd
    PyObject * field = NULL;
    field = raptor_dbw_msgs__msg__door_lock__convert_to_py(&ros_message->door_lock_cmd);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "door_lock_cmd", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
