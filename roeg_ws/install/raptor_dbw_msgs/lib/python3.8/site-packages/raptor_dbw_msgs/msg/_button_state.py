...
class Metaclass_ButtonState(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'NOT_PRESSED': cls.__constants['NOT_PRESSED'],
    ...
    def NOT_PRESSED(self):
        """Message constant 'NOT_PRESSED'."""
        return Metaclass_ButtonState.__constants['NOT_PRESSED']

    @property
    def PRESSED(self):
        """Message constant 'PRESSED'."""
        return Metaclass_ButtonState.__constants['PRESSED']

    @property
    def SNA(self):
        """Message constant 'SNA'."""
        return Metaclass_ButtonState.__constants['SNA']
