...
bool raptor_dbw_msgs__msg__driver_input_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // steer_wheel_button_a
    PyObject * field = PyObject_GetAttrString(_pymsg, "steer_wheel_button_a");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->steer_wheel_button_a = (Py_True == field);
    Py_DECREF(field);
  }
  {  // steer_wheel_button_b
    PyObject * field = PyObject_GetAttrString(_pymsg, "steer_wheel_button_b");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->steer_wheel_button_b = (Py_True == field);
    Py_DECREF(field);
  }
  {  // steer_wheel_button_c
    PyObject * field = PyObject_GetAttrString(_pymsg, "steer_wheel_button_c");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->steer_wheel_button_c = (Py_True == field);
    Py_DECREF(field);
  }
  {  // steer_wheel_button_d
    PyObject * field = PyObject_GetAttrString(_pymsg, "steer_wheel_button_d");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->steer_wheel_button_d = (Py_True == field);
    Py_DECREF(field);
  }
  {  // steer_wheel_button_e
    PyObject * field = PyObject_GetAttrString(_pymsg, "steer_wheel_button_e");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->steer_wheel_button_e = (Py_True == field);
    Py_DECREF(field);
  }
  {  // driver_door_ajar
...
PyObject * raptor_dbw_msgs__msg__driver_input_report__convert_to_py(void * raw_ros_message)
{
  ...
  {  // steer_wheel_button_a
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->steer_wheel_button_a ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "steer_wheel_button_a", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // steer_wheel_button_b
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->steer_wheel_button_b ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "steer_wheel_button_b", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // steer_wheel_button_c
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->steer_wheel_button_c ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "steer_wheel_button_c", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // steer_wheel_button_d
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->steer_wheel_button_d ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "steer_wheel_button_d", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // steer_wheel_button_e
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->steer_wheel_button_e ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "steer_wheel_button_e", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
