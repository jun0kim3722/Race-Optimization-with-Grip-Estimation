...
bool raptor_dbw_msgs__msg__gear_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // trans_curr_gear
    PyObject * field = PyObject_GetAttrString(_pymsg, "trans_curr_gear");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->trans_curr_gear = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  ...
  {  // gear_mismatch_flash
    PyObject * field = PyObject_GetAttrString(_pymsg, "gear_mismatch_flash");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->gear_mismatch_flash = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * raptor_dbw_msgs__msg__gear_report__convert_to_py(void * raw_ros_message)
{
  ...
  {  // trans_curr_gear
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->trans_curr_gear);
    {
      int rc = PyObject_SetAttrString(_pymessage, "trans_curr_gear", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // gear_mismatch_flash
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->gear_mismatch_flash ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "gear_mismatch_flash", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
